...
3. Следва да се премести папката influxify, която се намира във флашката, в папка htdocs (C:\xampp\htdocs). 
    ...
    - (трявба да се извлече от допълнителната папка influxify папката),
...
6. Следва да се отвори страница в браузъра, с URL [http://localhost/phpmyadmin/](http://localhost/phpmyadmin/).
...
8. Когато файловете на дипломната са прехвърлени в (C:\xampp\htdocs). 
    - В браузъра се пише URL: [http://localhost/influxify/user/](http://localhost/influxify/user/) за клиентска част, а в този URL админска част: [http://localhost/influxify/admin/admin_login.php](http://localhost/influxify/admin/admin_login.php).
    - (Чрез [http://localhost/influxify/admin/](http://localhost/influxify/admin/) може да се достъпи всички файлове от администратора, ако няма регистрация се препраща в [http://localhost/influxify/admin/admin_login.php](http://localhost/influxify/admin/admin_login.php))
...
10. Допълнителна информация относно проекта:
    ...
    - При добавяне на спецификации за всеки от продуктите е добре при Storage и RAM след числото да има слядо написано GB. (Пример: 16GB)
