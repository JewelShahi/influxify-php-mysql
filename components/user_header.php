...
<header class="header">
  <section class="flex">
    ...
    <nav class="navbar">
      ...
      <a href="orders.php"><i class="fa-solid fa-clipboard-list"></i> Поръчки</a>
      <a href="service.php"><i class="fa-solid fa-wrench"></i> Сервиз</a>
      <a href="contact.php"><i class="fas fa-phone"></i> Контакти</a>
    </nav>
